...
const Despesas = () => {
  ...
  const regularExpenses = expenses.filter(e => e.category !== "Cartão de Crédito" && e.category !== "Cartão");
  const filtered = filter === "todos" ? regularExpenses : regularExpenses.filter((e) => e.status === filter);
